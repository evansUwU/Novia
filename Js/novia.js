...
function ModoNovio(){ 
    ...
    BotonNovio.remove();
    Intro.remove();
    FondoPagina.style.backgroundImage = "url('https://diariodelamancha.com/wp-content/uploads/2023/01/red-heart-corazon-rojo-san-valentin-compartir-fondos-gratis-0002.jpg')";
...
btn_si2.addEventListener('click', function(e) { 
    clearInterval(tim2);
    btn_no2.remove();
    alert('Sabía que dirías que SI. Te amo <3💖') 
});
